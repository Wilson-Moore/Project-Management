      ...
      useEffect(() => {
            ...
            const fetchData = async () => {
                  ...
                  if (foundSubprogram) {
                        ...
                        const foundAction = subprogramData.actions.find(action => action.code === actionId);
                        if (foundAction) {
                              ...
                              const foundOperation = actionData.operations.find(op => op.number === operationId);
                              if (foundOperation) {
                                    const operationResponse = await axiosClient.get(`/operations/${operationId}?include=projects`);
            ...
            fetchData();
      }, [walletId, programId, subprogramId, actionId, operationId, projectId]);
